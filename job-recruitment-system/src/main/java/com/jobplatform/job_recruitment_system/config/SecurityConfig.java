    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/company/onboarding").hasAnyAuthority("COMPANY","CANDIDATE")
                        ...
                        .requestMatchers("/api/Skill").hasAnyAuthority("COMPANY","ADMIN","CANDIDATE")
                        .requestMatchers("/api/Skill/createbyuser").hasAnyAuthority("COMPANY","CANDIDATE")
                        .requestMatchers("/api/company/profile").hasAuthority("COMPANY")
                        .requestMatchers("/api/jobs/create").hasAuthority("COMPANY")
                        .requestMatchers("/api/jobs/jobpost").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/cvs/generate").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/cvs/save-cv").hasAuthority("CANDIDATE")
